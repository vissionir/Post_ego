...
const explorerSort = (a: any, b: any) => {
  ...
  const ruOrder = ["Атомы", "Как я сюда пришёл", "Миссия", "Как устроено исследование", "Область исследования"]
  const enOrder = ["Атомы", "Как я сюда пришёл", "Миссия", "Как устроено исследование", "Область исследования"]
